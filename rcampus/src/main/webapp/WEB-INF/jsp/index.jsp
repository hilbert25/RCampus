			...
			<div class="container">
					...
					<div class="col-sm-7">
						<div class="home--header">
							...
							<p>Master data analysis from the comfort of your browser, at
								...
								want to learn R, Python or Data Visualization, we want to help!</p>
						</div>
					</div>
					<div class="col-sm-5">
						<div class="home--sign-up card">
				...
				<div class="row home--header-icons">
					<div class="hidden-xs col-sm-3">
						<img
							src="https://cdn.datacamp.com/main-app/assets/home_logged_out/home_1-c66e2d9a6a9a29f2e6b028f67f01b30cd907d3673357b8cf9cabf78f10d65400.png"
							alt="Home 1" />
					</div>
					<div class="hidden-xs col-sm-3">
						<img
							src="https://cdn.datacamp.com/main-app/assets/home_logged_out/home_2-7a41ab899acfc1e73fd391137ee7183de57eed4e27fdfe2c43171dd7d32f3e59.png"
							alt="Home 2" />
					</div>
					<div class="hidden-xs col-sm-3">
						<img
							src="https://cdn.datacamp.com/main-app/assets/home_logged_out/home_3-8fcc69106e9c6e2dab72595934db9f407ba2965b7ae568d0a55e821693407838.png"
							alt="Home 3" />
					</div>
					<div class="hidden-xs col-sm-3">
						<img
							src="https://cdn.datacamp.com/main-app/assets/home_logged_out/home_4-772f427e12522647a5a1c325b6d123bb0deb1dff2e3a5f76ca371f8808f8d563.png"
							alt="Home 4" />
					</div>
				</div>
			...
			<div class="container text-center">
				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3">
						<p>No matter what industry youâre in, learning how to
							analyze and understand your data is critical. Thatâs why
							DataCamp provides you with the tools to learn the data science
							skills you need to start your own data projects.</p>
					</div>
				</div>
			</div>
			<div class="data-science-picture">
				<span class="gradient"></span> <img
					src="https://cdn.datacamp.com/main-app/assets/home_logged_out/home_data_science-555c6fd4d8790b9674c43168a9bf0c043f4be0f3da3e90923d0411c11fcfea73.svg"
					alt="Home data science" />
			</div>
		</section>
	</div>
</body>
